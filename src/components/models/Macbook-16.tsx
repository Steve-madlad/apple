...
Files: macbook-16.glb [639.28KB] > C:\Repo\apple\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/models/macbook-16-transformed.glb') as any;

  const texeture = useTexture('/screen.png');
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        rotation={[Math.PI / 2, 0, 0]}
      >
        <meshBasicMaterial map={texeture} />
      </mesh>
      <mesh
